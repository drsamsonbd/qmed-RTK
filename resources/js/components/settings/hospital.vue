...
//delete
       ...
       deleteCategory(id){
              ...
              if (result.value) {
                axios.delete('/api/hospital/'+id+ '?token='+ localStorage.getItem('token'))
               .then(() => {
                this.allCategory();
...
// show insert modal
 ...
 // show update modal
       toggleModal(id) {
         axios.get('/api/hospital/'+id+ '?token='+ localStorage.getItem('token'))
 ...
 //insert  
       categoryInsert(){
       axios.post('/api/hospital'+ '?token='+ localStorage.getItem('token'),this.form)
       .then(() => { 
 ...
 //update       
     categoryUpdate(){
       ...
       axios.patch('/api/hospital/'+id+ '?token='+ localStorage.getItem('token'),this.forms)
       .then(() => { 
