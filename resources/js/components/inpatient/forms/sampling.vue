...
<script type="text/javascript">
  ...
  methods:{
    allCases(){
     ...
     axios.get('/api/inpatientSampling/'+ this.$route.params.id+ '?token='+ localStorage.getItem('token'))
   ...
   locality(){
    ...
    let self = this;
     ...
     this.$router.push({name: 'inpatientdetails', params: { id:  this.form.kp_passport} });
     }, 
      goBack() {
